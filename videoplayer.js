...
function applyActive(id){
  ...
  playerwrapper.innerHTML=`<iframe id="video-player" src="https://player.vimeo.com/video/${videoPlaySectionData[id-1].vimeoId}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
